...
constr_eval_name_ord = ((A -> Interpolations.interpolate(A, Interpolations.BSpline{Interpolations.Constant}, Interpolations.OnCell),evaluate_grid,"IBSpline",0),
                    ...
                    (A -> py.RegularGridInterpolator(make_knots(A), A, method="nearest"),evaluate_grid,"Py",0),
                    (A -> py.RegularGridInterpolator(make_knots(A), A, method="linear"),evaluate_grid,"Py",1),
                    )
